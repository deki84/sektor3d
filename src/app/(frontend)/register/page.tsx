  ...
  return (
    <div className="mt-1.5">
      <div className="h-1 w-full rounded-full bg-gray-200">
        <div className={`h-1 rounded-full transition-all duration-300 ${config.color} ${config.width}`} />
      </div>
...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Nach erfolgreicher Registrierung auf "Bitte verifizieren"-Seite weiterleiten
      router.replace(
